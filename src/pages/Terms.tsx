    ...
    return (
        <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
            <SEO
                ...
                description="Read our Terms of Service to understand the rules and regulations for using Arrotech Hub."
                url="/terms"
                keywords={['Terms of Service', 'User Agreement', 'Legal', 'Arrotech Hub Terms']}
            />
